import os , json , random , time,webbrowser,datetime
...
class main:
    def __init__(self):
        ...
        self.ch = 0
        print(F+'━━━━━━━━━━━━━━━━━━')
        self.token = str(input(f'{Z} [{B}⌯{Z}] {B}اكتب التوكن{Z} » ' + C))
        print(F+'━━━━━━━━━━━━━━━━━━')
        self.id_telegram = input(f'{Z} [{B}⌯{Z}] {B}اكتب الايدي{Z} » ' + C)
        print(F+'━━━━━━━━━━━━━━━━━━')
        self.sessionid = input(f'{Z} [{B}⌯{Z}] {B}سيزون ايدي {Z} » ' + C)
        print(F+'━━━━━━━━━━━━━━━━━━')
            ...
            for email in emails:
                ...
                if "@hotmail.com" in self.email:
                    if self.ch_hotmail():
                        ...
                        self.unhotmail+=1
                self.clear()
                result = pyfiglet.figlet_format("WHX")
                print(result)
                print(f"{E}[{G}+{E}] {G}Hacked{A}: {G}{self.true}\t"+f"{E}ckecking {A}: {E}{self.false}")
                print(f"{E}[{S}+{E}] {S}Gmail       {A}: {G}{self.gmail}\t{E}ckecking️ {A}: {E}{self.ungmail}")
                print(f"{E}[{S}+{E}] {S}Yahoo      {A}: {G}{self.yahoo}\t{E}ckecking{A}: {E}{self.unyahoo}")
                print(f"{E}[{S}+{E}] {S}Hotmail   {A}: {G}{self.hotmail}\t{E}ckecking {A}: {E}{self.unhotmail}")
    def get_email(self):
 ...
 data : {data}
 \n
TELE  : @iiwiw @Professional_school
"""
